...
(O'Reilly Media, Inc. February 2005):

Two font systems:

* The X core fonts (a.k.a. X fonts)
...
## Installing X Core Fonts (aka "Traditional" X Fonts)


**[TODO]**  ORDER

1. Install font; that is, copy its files
2. Run `mkfontdir` to recreate the font database
3. Run `mkfontscale` to recreate an index of scalable font files for X
4. Run `xset fp+ /path/to/the/new/font`  to append it to the font path
5. Run `xset fp rehash` to  reread the font databases in the font path


### File fonts.dir    **[TODO]**

### File fonts.scale  **[TODO]**
