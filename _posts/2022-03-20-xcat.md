...
```
# grep -n CMDLINE /tmp/grubabacus211.ORIG
7:GRUB_CMDLINE_LINUX="crashkernel=auto rd.lvm.lv=xcatvg/root console=ttyS1,19200"
```

```
# sed -i.bkp 's/ttyS1,19200/ttyS1,19200 nomodeset/' /tmp/grubabacus211.ORIG
```
...
```
# scp /tmp/grubabacus211.ORIG root@abacus211:/etc/default/grub
```
